...
namespace ProConfiguration_IntelShipSpaceAnalys
{
    internal class ConfigurationManager1 : ConfigurationManager
    {
        ...
        protected override System.Windows.FrameworkElement OnShowStartPage()
        {
            ...
            string project = ConstPath_DefaultProjectPath;
            var page = new StartPage(project);
            page.DataContext = _vm;
            return page;
        }
        public const string ConstPath_DefaultProjectPath = @"E:\B\程序\程序\智能船舶航行空间分析系统\ProConfiguration_IntelShipSpaceAnalys\ProConfiguration_IntelShipSpaceAnalys\bin\IntelShipSpaceAnalys\IntelShipSpaceAnalys.aprx";
        ///<summary>
